    ...
    public static class ARConsole
    {
        ...
        private static bool CreateCuiConsole(string title)
        {
            ...
            finally
            {
                ...
                System.Console.WriteLine(UserDefinedStr.sAuthor);
                System.Console.WriteLine(UserDefinedStr.sHelperCpr);
                System.Console.WriteLine(UserDefinedStr.sLibCpr);
